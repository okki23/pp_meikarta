...
<body class="theme-red">
                        ...
                        <div class="modal-body">
                              <form method="post" id="user_form" enctype="multipart/form-data">   
								  ...
								  <hr>
								   ...
								   <button type="button" name="simpan_data" id="simpan_data" class="btn btn-success waves-effect"> <i class="material-icons">save</i> Simpan</button>
	...
	$("#simpan_data").on("click",function(){  
         ...
         if(tipe == ''){
            ...
            $("#unit").parents('.form-line').addClass('focused error');
            $("#unit").focus();
         }else{
	 ...
	 $('.datepicker').bootstrapMaterialDatePicker({
       ...
       $(document).ready(function() {
		...
		$('#example').DataTable( {
			"ajax": "<?php echo base_url(); ?>unit/fetch_user" 
		});
