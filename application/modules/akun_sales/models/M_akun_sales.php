...
copyright  : 2018 
deskripsi  : Class M_akun_sales berisi rincian method atau fungsi logic yang digunakan untuk melakukan transaksi data master akun_sales, dimana method yang terdaftar mengadopsi dari Parent Model
*/
class M_akun_sales extends Parent_Model { 
  ...
  */
  ...
  public function fetch_akun_sales(){   
		   $getdata = $this->db->query("SELECT a.*,b.nama from m_akun_sales a
                                    INNER JOIN m_sales b on b.id = a.id_sales")->result();
		   $data = array();  
		   $no = 1;
    ...
    public function fetch_nama_sales(){   
       $getdata = $this->db->get($this->nama_tabel_sales)->result();
       $data = array();  
