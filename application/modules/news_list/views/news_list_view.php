    ...
    <div class="container ">
        ...
        <div class="row">
            <div class="col-sm-7  col-lg-8">
                <div id="news_list-panel" class="panel">
                    <div class="panel-heading">
                        <h4 class="title mt10 mb0 semibold">Berita Utama</h4>
                        <br>
                        &nbsp;
                    </div>
                    <div class="panel-body pt0">
                        <div class="listContentTop clearfix">
                            ...
                            foreach ($list as $key => $value) {
                                ...
                                echo '<article>'.
                                     limit_to_numwords($value->content,20). "...".'</article></dl>';
                            }
                            ?>
                            <div class="clearfix"></div>
                            <br>
            ...
            <div class="col-sm-5 col-lg-4">
                <div id="news_list-panel" class="panel">
                    <div class="panel-heading">
                        <h4 class="title mt10 semibold">Berita Terkini</h4>
                    </div>
                    <div class="panel-body pt0">
...
<script src="<?php echo base_url('assets/f_news/js/'); ?>newslistmodule.js"></script>
        ...
        <script>
    //showMainGeneralnews_list('1');
    showMoreGeneralnews_list('1');
    optionFundManager('fund');
    optionFundName('fund');
    $( "#btnnews_listFilter" ).click();
    </script>
