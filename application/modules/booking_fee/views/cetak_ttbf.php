...
<table width="100%" cellpadding="0" cellspacing="3" >
    <tr>
        <td style="width: 20%;"> Kode TTBF </td>
        <td style="width: 5%;"> : </td>
        <td style="width: 30%;"> <?php  echo $trans->kode_ttbf; ?> </td>

        <td style="width: 20%;"> Priority Code </td>
        <td style="width: 5%;"> : </td>
        <td style="width: 30%;"> <?php  echo $trans->priority_code; ?> </td>
