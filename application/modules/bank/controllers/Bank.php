...
copyright  : 2018 
deskripsi  : Class bank berisi rincian method atau fungsi logic yang digunakan untuk melakukan olah data master bank, dimana method yang terdaftar mengadopsi dari Parent Controller
*/
...
class Bank extends Parent_Controller {
  ...
  */
  ...
  var $daftar_field = array('id', 'kode_bank', 'nama_bank', 'no_rekening', 'jumlah_kpa', 'user_insert', 'date_insert', 'user_update', 'date_update');
  var $primary_key = 'id';
  ...
  //method untuk memanggil halaman bank pertama kali
  ...
  //method atau fungsi yang digunakan untuk menyimpan data dari form,baik saat melakukan simpan maupun ubah data
    ...
    $simpan_data = $this->m_bank->simpan_data_master($data_form,$this->nama_tabel,$this->primary_key,$id);
