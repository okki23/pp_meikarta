...
copyright  : 2018 
deskripsi  : Class M_bank berisi rincian method atau fungsi logic yang digunakan untuk melakukan transaksi data master bank, dimana method yang terdaftar mengadopsi dari Parent Model
*/
class M_bank extends Parent_Model { 
  ...
  */
  ...
  var $daftar_field = array('id', 'blok_tower', 'lantai', 'no_bank', 'luas', 'tipe', 'foto', 'harga', 'user_insert', 'date_insert', 'user_update', 'date_update');
  var $primary_key = 'id';
